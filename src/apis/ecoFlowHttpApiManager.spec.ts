...
//       const actual = await manager.acquireCertificate(config, logMock);
...
//       await manager.acquireCertificate(config, logMock);
...
//       const actual = await manager.getAllQuotas(config, logMock);
...
//       const actual = await manager.getQuotas(quotas, config, logMock);
