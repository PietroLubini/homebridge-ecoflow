...
import { DiscoverySimulator } from '@ecoflow/accessories/discovery/simulations/discoverySimulator';
...
export class EcoFlowHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  private createAccessory(
    ...
    switch (config.model) {
      ...
      //  break;
      case DeviceModel.DeltaPro3:
        EcoFlowAccessoryType = DeltaPro3Accessory;
        EcoFlowAccessorySimulatorType = DeltaPro3Simulator;
        break;
      ...
      //   break;
      case DeviceModel.Discovery:
        EcoFlowAccessoryType = DiscoveryAccessory;
        EcoFlowAccessorySimulatorType = DiscoverySimulator;
        break;
