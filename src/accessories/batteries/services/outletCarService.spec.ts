...
describe('OutletCarService', () => {
  ...
  describe('updateStatusLowBattery', () => {
    it('should set low battery level when it is less than 20', () => {
      ...
      expect(logMock.debug.mock.calls).toEqual([['CAR StatusLowBattery ->', 1]]);
    });
    ...
    it('should set normal battery level when it is more than or equal to 20', () => {
      ...
      expect(logMock.debug.mock.calls).toEqual([['CAR StatusLowBattery ->', 0]]);
    });
  });
      ...
      expect(ecoFlowAccessoryMock.sendSetCommand).toHaveBeenCalledWith(
        {
          ...
          version: '',
          moduleType: 5,
          operateType: MqttBatterySetOperationType.MpptCar,
          params: {
            enabled: 1,
          },
        },
