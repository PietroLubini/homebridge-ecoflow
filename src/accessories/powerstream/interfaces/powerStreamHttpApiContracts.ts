...
export interface Heartbeat {
  ...
  invOnOff?: EnableType; //Micro-inverter switch: 0: off; 1: on (read)
  invBrightness?: number; //Micro-inverter LED brightness adjustment, 0-1023 (read/write)

  // Settings
  supplyPriority?: SupplyPriorityType; //Power supply priority: 0: prioritize power supply; 1: prioritize power storage (read/write)
